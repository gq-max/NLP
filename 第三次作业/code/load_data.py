...
"""此文件用于将数据文件去除停用词和提取词干后封装到data.txt文件中"""


def load_text(filepath, stopwords_file):
    """文件地址'D:/文件仓库/自然语言处理/NLP/第三次作业/3_newsgroups'
        停用词：D:/文件仓库/自然语言处理/NLP/第三次作业/stopwords.txt'
    """
    syntax_list = ['[^a-zA-Z\']']
...
text = load_text(filepath='D:/文件仓库/自然语言处理/NLP/第三次作业/3_newsgroups',
                 stopwords_file='D:/文件仓库/自然语言处理/NLP/第三次作业/stopwords.txt')
